...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        for add1 in node_a1.action.effect_add:
            for rem2 in node_a2.action.effect_rem:
                if add1 == rem2:
                    return True

        for add2 in node_a2.action.effect_add:
            for rem1 in node_a1.action.effect_rem:
                if add2 == rem1:
                    return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        '''
        for add1 in node_a1.action.effect_add:
            for neg2 in node_a2.action.precond_neg:
                if add1 == neg2:
                    return True
        ...
        for add2 in node_a2.action.effect_add:
            for neg1 in node_a1.action.precond_neg:
                if add2 == neg1:
                    return True
